...
const aunties2 = require('./aunties2');
...
describe('Day 16: Aunt Sue', () => {
  ...
  describe('Part Two', () => {
    it('should detect aunt with updated retroencabulator', () => {
      const aunts =
        `Sue 1: goldfish: 6, trees: 9, akitas: 0
         Sue 2: goldfish: 7, trees: 1, akitas: 0
         Sue 3: cars: 10, akitas: 6, perfumes: 7
         ...
         Sue 7: cars: 6, vizslas: 5, cats: 3
         Sue 8: akitas: 10, vizslas: 9, children: 3
         Sue 9: goldfish: 4, cats: 8, trees: 4
         Sue 10: perfumes: 10, trees: 6, cars: 4`;
      ...
      assert.strictEqual(aunties2(aunts, giftCompounds), 9);
    });
  });
});
